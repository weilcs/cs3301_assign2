...
public class SmoothingFilter extends Frame implements ActionListener {
  ...
  private int checkIfXCoordinateIsValid(int x) {
    if (x > width) {
      return width - 1;
    }
    if (x < 0) {
  ...
  private int checkIfYCoordinateIsValid(int y) {
    if (y > height) {
      return height - 1;
    }
    if (y < 0) {
  ...
  private Color[] generateMatrix(int y, int x) {
      ...
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-2), checkIfXCoordinateIsValid(y+2));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-2), checkIfXCoordinateIsValid(y+1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-2), checkIfXCoordinateIsValid(y));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-2), checkIfXCoordinateIsValid(y-1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-2), checkIfXCoordinateIsValid(y-2));

      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-1), checkIfXCoordinateIsValid(y+2));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-1), checkIfXCoordinateIsValid(y+1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-1), checkIfXCoordinateIsValid(y));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-1), checkIfXCoordinateIsValid(y-1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x-1), checkIfXCoordinateIsValid(y-2));

      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x), checkIfXCoordinateIsValid(y+2));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x), checkIfXCoordinateIsValid(y+1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x), checkIfXCoordinateIsValid(y));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x), checkIfXCoordinateIsValid(y-1));
      subMatrix = unmodifiedInput.getRGB(checkIfXCoordinateIsValid(x), checkIfXCoordinateIsValid(y-2));
